...
class SC4GameTableBase : private cIGZUnknown
{
protected:
	SC4GameTableBase(const char* tableName);

public:
	void Register(cISC4GameDataRegistry& registry);

protected:
	virtual void RegisterTableFunctions(
		cISC4GameDataRegistry::cEntry* parentNode,
		cISC4GameDataRegistry& registry) = 0;
